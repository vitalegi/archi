...
public class AbstractDiagramProcessorTests {

    AbstractDiagramProcessor<?> processor;

    @BeforeEach
    void init() {
        processor = new AbstractDiagramProcessor<>() {
            @Override
            ...
            @Override
            public String createPuml(Workspace workspace, Diagram diagram) {
                return null;
            }
        };
    }
